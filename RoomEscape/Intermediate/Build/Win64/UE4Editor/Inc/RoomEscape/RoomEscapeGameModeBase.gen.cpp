...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ARoomEscapeGameModeBase()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = ARoomEscapeGameModeBase::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<ARoomEscapeGameModeBase> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("HideCategories"), TEXT("Info Rendering MovementReplication Replication Actor Input Movement Collision Rendering Utilities|Transformation"));
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("RoomEscapeGameModeBase.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("RoomEscapeGameModeBase.h"));
	...
	IMPLEMENT_CLASS(ARoomEscapeGameModeBase, 1860423824);
